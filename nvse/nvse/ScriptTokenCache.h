...
struct TokenCacheEntry
{
	...
	explicit TokenCacheEntry(ScriptToken* scriptToken) : token(scriptToken), eval(nullptr), swapOrder(false) {}
};
...
public:
	std::size_t incrementData = 0;
	[[nodiscard]] TokenCacheEntry& Get(std::size_t key) const;
