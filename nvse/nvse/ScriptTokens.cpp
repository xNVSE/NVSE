...
char* ScriptToken::DebugPrint(void)
{
	switch (type) {
		...
		case kTokenType_Command: sprintf_s(debugPrint, 512, "[Type=Command, Value=%lu]", value.cmd->opcode); break;
#if RUNTIME
		...
		case kTokenType_ArrayVar: sprintf_s(debugPrint, 512, "[Type=ArrayVar, Value=%lu]", value.arrID); break;
