...
static ParamInfo kParamsTempCloneForm[] =
{
	{	"form",	kParamType_AnyForm,	0	},
	{	"bInheritModIndex",	kParamType_Integer,	1	},
};

DEFINE_CMD(CloneForm, "clones the specified form and returns a new base form which will be saved in the save game.", false, kParamsTempCloneForm);
