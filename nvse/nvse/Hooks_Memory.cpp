...
void Hooks_Memory_PreloadCommit(bool isNoGore) {
	...
	constexpr UInt32 kVanilla_defaultHeapInitialAllocMB = 200;
	constexpr UInt32 kVanilla_scrapHeapSizeMB = 64;
	...
	if(	(defaultHeapInitialAllocMB != kVanilla_defaultHeapInitialAllocMB) ||
		...
		constexpr UInt32 kMax_defaultHeapInitialAllocMB = 500;	// issues have been reported while using 500
		constexpr UInt32 kMax_scrapHeapSizeMB = 128;
